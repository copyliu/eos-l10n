...
mapper(Fit, fits_table,
       properties = {"_Fit__modules" : relation(Module, backref = "fit", collection_class = HandledList,
                     ...
                     "_Fit__projectedModules" : relation(Module, backref = "target", collection_class = HandledList,
                     ...
                     "_Fit__projectedDrones" : relation(Drone, backref = "target", collection_class = HandledDroneList,
