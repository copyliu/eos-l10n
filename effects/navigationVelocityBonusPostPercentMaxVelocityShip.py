...
#Variations of item: Large Auxiliary Thrusters I (2 of 2)
#Variations of item: Medium Auxiliary Thrusters I (2 of 2)
#Variations of item: Small Auxiliary Thrusters I (2 of 2)
#Item: Navigation
