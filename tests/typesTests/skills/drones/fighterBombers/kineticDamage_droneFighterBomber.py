...
class Test(unittest.TestCase):
    def setUp(self):
        ...
        self.iValEos = self.iDrone.getModifiedChargeAttr(self.targetAttrName)
        # Define final setup
        self.fFit = Fit()
        self.fSkillLvl = 4
        ...
        self.fValEos = self.fDrone.getModifiedChargeAttr(self.targetAttrName)

    def test_init_eos_theory(self):
        # Affected
        iValTheory = ModifiedAttributeDict()
        iValTheory.original = self.iDrone.chargeModifiedAttributes.original
    ...
    def test_final_eos_theory(self):
        ...
        fValTheory.original = self.fDrone.chargeModifiedAttributes.original
