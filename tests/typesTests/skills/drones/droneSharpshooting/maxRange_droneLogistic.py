...
class Test(unittest.TestCase):
    def setUp(self):
        self.targetAttrName = "maxRange"
        self.skill = db.getItem("Drone Sharpshooting")
        self.skillBonus = self.skill.getAttribute("rangeSkillBonus")
        self.ship = db.getItem("Ishtar")
        self.item = db.getItem("Heavy Armor Maintenance Bot I")
