...
class Test(unittest.TestCase):
    def setUp(self):
        self.targetAttrName = "armorDamageAmount"
        self.skill = db.getItem("Repair Drone Operation")
        self.skillBonus = self.skill.getAttribute("damageHP")
        self.ship = db.getItem("Pilgrim")
        self.item = db.getItem("Light Armor Maintenance Bot II")
