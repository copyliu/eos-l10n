...
class Test(unittest.TestCase):
    def setUp(self):
        self.targetAttrName = "consumptionQuantity"
        self.skill = db.getItem("Cynosural Field Theory")
        self.skillBonus = self.skill.getAttribute("consumptionQuantityBonusPercentage")
        self.ship = db.getItem("Thorax")
        self.item = db.getItem("Cynosural Field Generator I")
