...
class Test(unittest.TestCase):
    def setUp(self):
        self.targetAttrName = "falloff"
        self.skill = db.getItem("Frequency Modulation")
        self.skillBonus = self.skill.getAttribute("falloffBonus")
        self.ship = db.getItem("Incursus")
        self.item = db.getItem("Remote Sensor Dampener I")
