...
class Test(unittest.TestCase):
    def setUp(self):
        self.targetAttrName = "cloakingTargetingDelay"
        self.skill = db.getItem("Cloaking")
        self.skillBonus = self.skill.getAttribute("cloakingTargetingDelayBonus")
        self.ship = db.getItem("Raven")
        self.item = db.getItem("Prototype Cloaking Device I")
