...
class Test(unittest.TestCase):
    def setUp(self):
        self.targetAttrName = "capacitorNeed"
        self.skill = db.getItem("Electronic Warfare")
        self.skillBonus = self.skill.getAttribute("capNeedBonus")
        self.ship = db.getItem("Taranis")
        self.item = db.getItem("ECM - Multispectral Jammer I")
