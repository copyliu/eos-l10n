...
class Test(TestBase):
    ...
    def test_minmatarElectronicSystems_maxRange_moduleTractorBeamSkillrqGraviton(self):
        self.buildTested = 0
        attr = "maxRange"
    ...
    def test_minmatarElectronicSystems_maxRange_moduleTractorBeamSkillrqSalvaging(self):
        self.buildTested = 0
        attr = "maxRange"
        item = "Salvager I"
        iLvl = 1
